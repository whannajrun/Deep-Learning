...
# Data dummy: 3 kelas (0=T-shirt, 1=Celana, 2=Sepatu), 2 fitur (misal: hasil ekstraksi gambar)
X = np.array([
    [0.2, 0.8],
    [0.1, 0.7],
    [0.25, 0.85],
...
plt.xlabel('Fitur 1')
plt.ylabel('Fitur 2')
plt.title('Visualisasi Data Dummy Gambar')
plt.legend()
plt.show()
...
ConfusionMatrixDisplay.from_estimator(clf, X_test, y_test, display_labels=['T-shirt','Celana','Sepatu'])
